          ...
          >
            <Row>
              <Col lg="12" md="10">
                ...
                >
                  The similarity score between you and {this.props.first_name + " " + this.props.last_name} is: {this.props.score} % &nbsp;
                </h1>
                <p
                  className="text-white mt-0 mb-5"
                  style={{ fontSize: "1.2rem" }}
                >
                  You can also find visualizations of {this.props.first_name + " " + this.props.last_name}'s interests in the sidebar.
                </p>
              </Col>
            </Row>
          </Container>
